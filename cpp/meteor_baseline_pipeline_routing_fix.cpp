...
private:
    ...
    void process_client_request(int client_fd) {
        ...
        // User insight: "Single GET/SET is similar to pipeline with command size = 1"
        // This eliminates the slow single-command path (10ms p99.9) in favor of 
        // the proven-fast pipeline path (0.2ms p99.9) for 50x latency improvement
