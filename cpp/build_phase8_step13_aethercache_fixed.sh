...
if [[ "$ARCH" == "arm64" ]]; then
    ...
    INCLUDE_PATHS="-I/opt/homebrew/include -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I."
...
g++ -std=c++17 \
    ...
    -ffast-math \
    -pthread \
    sharded_server_phase8_step13_aethercache_fixed.cpp \
    -o meteor_phase8_step13_aethercache_fixed

if [ $? -eq 0 ]; then
    echo "✅ Phase 8 Step 13 build successful!"
    echo "📊 Binary: meteor_phase8_step13_aethercache_fixed"
