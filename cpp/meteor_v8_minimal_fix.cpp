...
public:
    ...
    void submit_operation(const std::string& command, const std::string& key, 
                         const std::string& value, int client_fd) {
        // **LATENCY FIX**: Process immediately instead of batching (eliminates MAX_BATCH_DELAY)
        // This matches the immediate processing behavior of execute_single_operation()
