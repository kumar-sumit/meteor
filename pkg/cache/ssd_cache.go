...
func (c *SSDCache) Put(ctx context.Context, key string, value []byte) error {
...
// updateMemoryCache updates the memory cache with a new value
func (c *SSDCache) updateMemoryCache(key string, value []byte) {
	...
	// Add new entry
	c.memoryCache.Store(key, &CacheEntry{
		value:      value,
